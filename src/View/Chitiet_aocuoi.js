...
import { StyleSheet, Text, View, ScrollView, Image, FlatList, Pressable, TextInput, ImageBackground } from 'react-native'; // Import ImageBackground
...
const Chitiet_aocuoi = () => {
  ...
  useEffect(() => {
    const fetchAlbums = async () => {
      try {
        const response = await axios.get('http://192.168.0.104:3000/album/get-list-Albums');
  ...
  return (
    <ScrollView>
      ...
      <View style={{ position: 'relative' }}>
        <View style={{ width: 350, height: 300, backgroundColor: "#f3d9dc", marginTop: 15, borderRadius: 20, marginLeft: 20 }}>
